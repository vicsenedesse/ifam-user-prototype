...
export class ListUserComponent implements OnInit {
  ...
  set filter(any: any) {
    ...
    //foi uma luta
      ...
      // this.filteredUser = this.filteredUser.indexOf(this._filterBy.toLocaleLowerCase()) > -1;
                          // this._users.filter((user: User) => user.name.toLocaleLowerCase().indexOf(this._filterBy.toLocaleLowerCase()) > -1) &&
                          // this._users.filter((user: User) => user.login.toLocaleLowerCase().indexOf(this._filterBy.toLocaleLowerCase()) > -1)
